...
const StudentDashboard = () => {
    ...
    // Define routes for easier mapping
    const routes = [
        { path: '/', element: <StudentHomePage /> },
        { path: '/Student/dashboard', element: <StudentHomePage /> },
        { path: '/Student/profile', element: <StudentProfile /> },
        { path: '/Student/subjects', element: <StudentSubjects /> },
        { path: '/Student/attendance', element: <ViewStdAttendance /> },
        { path: '/Student/complain', element: <StudentComplain /> },
